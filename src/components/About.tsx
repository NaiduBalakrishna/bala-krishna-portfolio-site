            ...
            <div className="relative">
              ...
              <div className="absolute -bottom-6 -right-6 glass-card p-6 transform rotate-3 hover:rotate-0 transition-all duration-500 hover-lift">
                <div className="text-center">
                  ...
                  <div className="text-xs text-muted-foreground font-medium text-mono">CGPA</div>
                </div>
              </div>
              ...
              <div className="absolute -top-6 -left-6 glass-card p-6 transform -rotate-3 hover:rotate-0 transition-all duration-500 hover-lift">
                <div className="text-center">
                  ...
                  <div className="text-xs text-muted-foreground font-medium text-mono">NSS Hours</div>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="space-y-8">
            ...
            <div className="grid grid-cols-2 gap-6">
              <div className="glass-card p-6 text-center hover-lift interactive-card">
                ...
                <div className="text-xs text-muted-foreground text-mono">B.Tech CSE</div>
              </div>
              <div className="glass-card p-6 text-center hover-lift interactive-card">
                <div className="card-glow"></div>
                ...
                <div className="text-xs text-muted-foreground text-mono">Community Service</div>
              </div>
            </div>
