...
export const About = () => {
  return (
    <section id="about" className="py-20 bg-gradient-to-br from-white via-blue-50/30 to-slate-50">
        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          <div className="relative group">
            ...
            <div className="relative">
              <div className="w-full max-w-md mx-auto rounded-3xl overflow-hidden shadow-2xl transform group-hover:scale-105 transition-all duration-500">
                <img 
          ...
          <div className="space-y-8">
            <div className="space-y-6">
              ...
              <div className="space-y-6 text-gray-600 leading-relaxed text-lg">
                ...
                <div className="bg-gradient-to-r from-blue-50 to-slate-50 p-6 rounded-xl shadow-lg">
                  <p>
                ...
                <div className="bg-gradient-to-r from-slate-50 to-blue-50 p-6 rounded-xl shadow-lg">
                  <p>
                    When I'm not coding, you'll find me exploring new frameworks, contributing to 
                    open-source projects, or volunteering in <strong>community service activities</strong>.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="grid grid-cols-2 gap-6 pt-6">
              ...
              <div className="bg-gradient-to-br from-green-500 to-green-600 text-white p-6 rounded-xl shadow-xl transform hover:scale-105 transition-all duration-300">
                ...
                <div className="mt-2 text-xs text-green-200">Community Service</div>
              </div>
            </div>
            ...
            <div className="bg-white p-6 rounded-xl shadow-lg">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                ...
                <div className="flex items-center space-x-3 p-3 bg-purple-50 rounded-lg">
                  ...
                  <span className="text-gray-700">Open Source Contribution</span>
                </div>
